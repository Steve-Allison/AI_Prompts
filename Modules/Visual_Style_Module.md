...
* Reviewer/SME can edit:

  * Any field for style, accessibility, or learning alignment
  * Add custom branding or alt text policies
* **Change Log:**

  * Auto-incremented version and date
  * “What’s new” summary per revision
